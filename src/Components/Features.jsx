    ...
    <section className="bg-gray-900 text-gray-200 py-16" id="features">
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Admin Feature */}
          <div
            onClick={onAdminClick} // ✅ React state based
            className="cursor-pointer p-6 bg-gradient-to-br from-red-600 via-red-700 to-red-800 rounded-xl shadow-lg hover:scale-105 transform transition duration-300 h-full"
          >
